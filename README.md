...
```bash
git clone https://github.com/pelbyl/claude-skill-excalidraw.git ~/.claude/skills/excalidraw
```

## Prerequisites

In Obsidian: **Settings → Excalidraw → Saving → Compress Excalidraw JSON in Markdown** must be **OFF**.
